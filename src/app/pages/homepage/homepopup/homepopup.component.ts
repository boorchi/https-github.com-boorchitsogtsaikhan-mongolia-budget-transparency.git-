...
export class HomepopupComponent implements OnInit {
  ...
  getBudget() {    
    this.mainService.baseGet(Constants.HOST + Constants.BUDGET_MAIN + "?year=" + 2021, null, true).then((result: any) => {     
      result.forEach(item => {
    ...
    this.mainService.baseGet(Constants.HOST + Constants.BUDGET_MAIN + "?year=" + 2021 + "&type=SUBMITTED&code=IN", null, true).then((result: any) => {     
      result.forEach(item => {
    ...
    this.mainService.baseGet(Constants.HOST + Constants.BUDGET_MAIN + "?year=" + 2021 + "&type=SUBMITTED&code=OUT", null, true).then((result: any) => {     
      result.forEach(item => {
