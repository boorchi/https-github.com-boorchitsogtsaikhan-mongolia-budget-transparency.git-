...
export class DebitConceptComponent implements OnInit {
  ...
  getBodlogo(){   
    this.mainService.baseGet(Constants.HOST + Constants.BUDGET_BODLOGO_ZO + "?year=" + this.params["year"] + "&type=Z", null, true).then((result: []) => {
