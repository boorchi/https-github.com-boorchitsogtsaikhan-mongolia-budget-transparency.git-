...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["income-new-income-new-module"], {
  ...
  /***/
  function _src_app_budget_incomeNew_incomeNewComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "IncomeNewComponent", function () {
      return IncomeNewComponent;
    });
    /* harmony import */
    ...
    var _modules_carousel_carousel_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var IncomeNewComponent = /*#__PURE__*/function () {
      function IncomeNewComponent(mainService, route, router) {
        var _this = this;

        _classCallCheck(this, IncomeNewComponent);
      ...
      return _createClass(IncomeNewComponent, [{
        key: "setQueryParam",
    ...
    IncomeNewComponent.ɵfac = function IncomeNewComponent_Factory(t) {
      return new (t || IncomeNewComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_main_service__WEBPACK_IMPORTED_MODULE_3__["MainService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
    };

    IncomeNewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: IncomeNewComponent,
      selectors: [["app-income-new"]],
      decls: 7,
      vars: 5,
      consts: [[1, "budget-content"], [1, "budget-top"], [1, "trapezoid"], [3, "showSelect", "showYear", "show"], [1, "budget-main-invest", "investment"], [1, ""], [3, "slideData"]],
      template: function IncomeNewComponent_Template(rf, ctx) {
        if (rf & 1) {
      ...
      directives: [_modules_year_change_year_change_component__WEBPACK_IMPORTED_MODULE_4__["YearChangeComponent"], _modules_carousel_carousel_component__WEBPACK_IMPORTED_MODULE_5__["CarouselComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IncomeNewComponent, [{
  ...
  /***/
  function _src_app_budget_incomeNew_incomeNewModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "IncomeNewModule", function () {
      return IncomeNewModule;
    });
    /* harmony import */
    ...
    var _income_new_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./income-new.component */
    "./src/app/budget/income-new/income-new.component.ts");
    /* harmony import */
    ...
    var IncomeNewModule = /*#__PURE__*/_createClass(function IncomeNewModule() {
      _classCallCheck(this, IncomeNewModule);
    });

    IncomeNewModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: IncomeNewModule
    });
    IncomeNewModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function IncomeNewModule_Factory(t) {
        return new (t || IncomeNewModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](IncomeNewModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IncomeNewModule, [{
...
//# sourceMappingURL=income-new-income-new-module-es5.js.map