...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["investment-investment-module"], {
  ...
  /***/
  function _src_app_budget_investment_investmentComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "InvestmentComponent", function () {
    ...
    var _modules_carousel_carousel_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../modules/carousel/carousel.component */
    "./src/app/modules/carousel/carousel.component.ts");

    function InvestmentComponent_ng_container_20_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function InvestmentComponent_div_21_i_feather_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "i-feather", 33);
      }
    }

    function InvestmentComponent_div_21_i_feather_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "i-feather", 34);
      }
    }

    function InvestmentComponent_div_21_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function InvestmentComponent_div_23_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function InvestmentComponent_div_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function InvestmentComponent_tr_59_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var InvestmentComponent = /*#__PURE__*/function () {
      function InvestmentComponent(mainService, route, router) {
        var _this = this;

        _classCallCheck(this, InvestmentComponent);
      ...
      return _createClass(InvestmentComponent, [{
        key: "ngOnInit",
        ...
        value: function getDefault() {
          ...
          this.mainService.baseGet(src_app_services_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].HOST + src_app_services_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].BUDGET_HURUNGU_DETAIL + "?year=" + this.params["year"] + "&category=HO", null, true).then(function (result) {
            ...
            result.forEach(function (item) {
              _this2.event.push(item["eventCount"]);
            });
            _this2.total = _this2.event.reduce(function (a, b) {
              return a + b;
            }, 0);
          ...
          this.mainService.baseGet(src_app_services_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].HOST + src_app_services_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].BUDGET_HURUNGU_DETAIL + "?year=" + this.params["year"] + "&category=LO", null, true).then(function (result) {
            _this2.loList = result;

            if (result.length == 0) {
              _this2.isLoNull = true;
              _this2.def = 'Тухайн онд харуулах өгөгдөл байхгүй байна..';
            } else {
              _this2.isLoNull = false;
            }
          })["catch"](function (error) {
            console.log(error);
          });
        ...
        value: function getDatas() {
          ...
          this.mainService.baseGet(src_app_services_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].HOST + src_app_services_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].BUDGET_HURUNGU + "?year=" + this.params["year"] + "&category=" + this.params["category"], null, true).then(function (result) {
            _this3.datas = result;
            ...
            result.forEach(function (item) {
              _this3.zarlagaTotal["approvedValue"] += item["approvedValue"];
              _this3.zarlagaTotal["perfoValue"] += item["perfoValue"];
              _this3.zarlagaTotal["percent"] = item["percent"];

              if (item["code"] === "HO2") {
                _this3.ulsiinTusuv = item["approvedValue"];
                _this3.percent = item["percent"];
                _this3.perfoValue = item["perfoValue"];
              }
            });
        ...
        key: "beforePer",
        value: function beforePer() {
          var _this4 = this;

          this.mainService.baseGet(src_app_services_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].HOST + src_app_services_constants__WEBPACK_IMPORTED_MODULE_1__["Constants"].BUDGET_HURUNGU + "?year=" + this.beforeYear + "&category=" + this.params["category"], null, true).then(function (result) {
            _this4.totalApp = 0;
            result.forEach(function (item) {
              _this4.totalApp += item["approvedValue"];
            });
            _this4.percentTotal = isFinite(Math.floor((_this4.zarlagaTotal["approvedValue"] - _this4.totalApp) / _this4.totalApp * 100)) ? Math.floor((_this4.zarlagaTotal["approvedValue"] - _this4.totalApp) / _this4.totalApp * 100) : 0;
          })["catch"](function (error) {
            console.log(error);
          });
        }
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InvestmentComponent, [{
  ...
  /***/
  function _src_app_budget_investment_investmentModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "InvestmentModule", function () {
    ...
    var _investment_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var src_app_modules_carousel_ng_carousel_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var InvestmentModule = /*#__PURE__*/_createClass(function InvestmentModule() {
      _classCallCheck(this, InvestmentModule);
    });

    InvestmentModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: InvestmentModule
    });
    InvestmentModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function InvestmentModule_Factory(t) {
        return new (t || InvestmentModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), src_app_modules_year_change_year_change_module__WEBPACK_IMPORTED_MODULE_4__["YearChangeModule"], src_app_icons_icons_module__WEBPACK_IMPORTED_MODULE_5__["IconsModule"], src_app_modules_description_description_module__WEBPACK_IMPORTED_MODULE_6__["DescriptionModule"], src_app_modules_carousel_ng_carousel_module__WEBPACK_IMPORTED_MODULE_7__["NgCarouselModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](InvestmentModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](InvestmentModule, [{
...
//# sourceMappingURL=investment-investment-module-es5.js.map